...
class ProjectTargetUserScreen extends Screen
{
  /**
  ...
  {
    return [
      'projects' => Project::filters()->defaultSort('id')->paginate()
    ];
  }
  ...
  public function layout(): iterable
  {
    return [
      ...
      Layout::modal('projectModal', Layout::rows([
        ...
        Select::make('user_id')
          ->title('User')
          ->fromQuery(User::where('role_id', 1), 'email', 'id'),
      ]))
  ...
  public function create(Request $request)
  {
    try {
      ...
      $projectController->storeTarget($request);
